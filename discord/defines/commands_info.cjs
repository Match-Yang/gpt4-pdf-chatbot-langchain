...
DiscordSlashCommandPineconeInfo[DiscordSlashCommandName.kFlutterLiveAudioRoomKit] = {pinecone_index_name: PineconeIndexNameUIKit, pinecone_name_space: 'flutter_live_audio_room_kit'};
